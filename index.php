...
function checkRoute(Cliente $cliente): void
{
    if (isset($_POST["nome"])) {
            ...
            <table border="0" cellpadding="2" cellspacing="0" class="box">
                ...
                <tr class="linha">
                    <td colspan="2" align="center">
                        <input name="adicionar" type="button" class="botao" id="adicionar" value="adicionar" onClick="
                exibir('fCad');
                ocultar('fFiltro');
                fCad.nome.focus();" style="background-color:#096">
                    </td>
                </tr>
            </table>
        </form>
            ...
            <table border="0" cellpadding="2" cellspacing="0" class="box">
                ...
                <tr class="linha">
                    <td colspan="2" align="right">
                        <input name="filtrar" type="reset" class="botao" id="filtrar" value="cancelar" onClick="
                ocultar('fCad');
                exibir('fFiltro');
        ...
        <table border="0" align="center" cellpadding="4" cellspacing="0" class="box">
            ...
            <?php foreach ($clientes as $cliente) : ?>
                <tr class="linha">
                    ...
                    <td><?= $cliente['nome'] ?></td>
                    <td><?= $cliente['cpf'] ?></td>
                    <td><input name="adicionar" type="button" class="botao" id="adicionar" value="x" onClick="confirmar('index.php?del=<?= $cliente['id'] ?>','TEM CERTEZA QUE DESEJA APAGAR ESSE CLIENTE?');" style="background-color:#C00"></td>
                </tr>
            <?php endforeach; ?>
        </table>
    </div>
